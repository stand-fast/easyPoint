  ...
  methods: {
    ...
    submitVehicle() {
      ...
      if (this.check == true) {
        if (
          confirm(
            ' 车牌号 : ' + this.licensePlateNumberChange ||
              this.licensePlateNumber +
                '\r 车辆类型 : ' +
                this.vehicleTypeChange ||
              this.vehicleType + '\r 车身颜色 : ' + this.colorChange ||
              this.color + '\r 司机姓名 :' + this.driverNameChange ||
              this.driverName + '\r 司机联系方式 : ' + this.driverPhoneChange ||
              this.driverPhone
          )
        ) {
          this.$http
            .get('接口路径', {
              params: {
                travelOrderId: 10,
                licensePlateNumber:
                  that.licensePlateNumberChange || that.licensePlateNumber,
